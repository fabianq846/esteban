...
class PostulacionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create postulacion" do
    assert_difference("Postulacion.count") do
      post postulacions_url, params: { postulacion: { oferta_laboral_id: @postulacion.oferta_laboral_id, user_id: @postulacion.user_id } }
    end
  ...
  test "should update postulacion" do
    patch postulacion_url(@postulacion), params: { postulacion: { oferta_laboral_id: @postulacion.oferta_laboral_id, user_id: @postulacion.user_id } }
